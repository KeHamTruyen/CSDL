...
(
    ...
    GiamToiDa           DECIMAL(18, 2)  NOT NULL    DEFAULT 0,
...
ALTER TABLE XuatHoaDon ADD CONSTRAINT FK_XuatHoaDon_NhanVien FOREIGN KEY (MaNhanVien) REFERENCES PhucVu(MaNhanVien);
...
ALTER TABLE DonHang ADD CONSTRAINT FK_DonHang_KhuyenMai FOREIGN KEY (MaKhuyenMai) REFERENCES KhuyenMaiTheoDon(MaKhuyenMai);
...
ALTER Table KhuyenMaiTheoDon ADD CONSTRAINT FK_KhuyenMaiTheoDon_ChuongTrinhKhuyenMai FOREIGN KEY (MaKhuyenMai) REFERENCES ChuongTrinhKhuyenMai(MaKhuyenMai);
